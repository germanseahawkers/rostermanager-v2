...
function translations(string $locale): array
{
    $messages = [
        'de' => [
            ...
            'intro_body_followup' => 'Wenn du fertig bist, kannst du deine Prognose per Link teilen, mit anderen 12s diskutieren und jederzeit zurückkommen, um deinen Kader an neue Entwicklungen anzupassen.',
            ...
            'share_body' => 'Dein Ergebnis bekommt eine eigene URL und eine Social-Vorschau beim Teilen des Links.',
            'review_title' => 'Review',
            'review_body' => 'Prüfe deinen finalen 53er-Kader und teile ihn in WhatsApp-Gruppen, auf Social oder direkt im Fanclub.',
            'share_meta_description_named' => 'Schau dir den Seahawks-53er-Kader von %s an und erstelle danach deinen eigenen Cutdown-Roster.',
            'share_meta_description_default' => 'Schau dir diesen Seahawks-53er-Kader an und erstelle danach deinen eigenen Cutdown-Roster.',
            ...
            'personalize_body' => 'Gib deinem 53er-Roster einen eigenen Namen und wähle ein Farbschema für Share-Seite und Link-Vorschau.',
        ...
        'en' => [
            ...
            'intro_body_followup' => 'Once you are done, share your roster by link, debate your call with fellow 12s and come back any time to adjust your cuts as the offseason evolves.',
            ...
            'share_body' => 'Every result gets its own URL plus a social preview when the link is shared.',
            'review_title' => 'Review',
            ...
            'share_meta_description_named' => 'Check out %s\'s Seahawks 53-man roster, then build your own cutdown squad.',
            'share_meta_description_default' => 'Check out this Seahawks 53-man roster, then build your own cutdown squad.',
            'copy_link' => 'Copy link',
            ...
            'personalize_body' => 'Give your final roster your own name and choose a color scheme for the share page and link preview.',
        ...
        'es' => [
            ...
            'intro_body_followup' => 'Cuando termines, podrás compartir tu roster mediante un enlace, comentarlo con otros 12s y volver cuando quieras para ajustar tus cortes durante la offseason.',
            ...
            'share_body' => 'Cada resultado recibe su propia URL y una vista previa social al compartir el enlace.',
            ...
            'share_meta_description_named' => 'Mira el roster de 53 de los Seahawks de %s y luego crea tu propio equipo para el cutdown.',
            'share_meta_description_default' => 'Mira este roster de 53 de los Seahawks y luego crea tu propio equipo para el cutdown.',
            ...
            'personalize_body' => 'Dale tu propio nombre a tu roster final y elige un esquema de color para la página y la vista previa del enlace.',
        ...
        'fr' => [
            ...
            'intro_body_followup' => 'Une fois terminé, tu peux partager ton roster via un lien, en discuter avec les autres 12s et revenir plus tard pour ajuster tes cuts pendant l’offseason.',
            ...
            'share_body' => 'Chaque résultat reçoit sa propre URL ainsi qu’un aperçu social lors du partage du lien.',
            'review_title' => 'Revue',
            ...
            'share_meta_description_named' => 'Découvre l’effectif Seahawks à 53 joueurs de %s, puis crée ton propre roster final.',
            'share_meta_description_default' => 'Découvre cet effectif Seahawks à 53 joueurs, puis crée ton propre roster final.',
            ...
            'personalize_body' => 'Donne un nom à ton effectif final et choisis un schéma de couleurs pour la page et l’aperçu du lien.',
        ...
        'pt' => [
            ...
            'intro_body_followup' => 'Quando terminar, você poderá compartilhar o roster por link, discutir a sua previsão com outros 12s e voltar depois para ajustar os cortes ao longo da offseason.',
            ...
            'share_body' => 'Cada resultado recebe sua própria URL e uma prévia social ao compartilhar o link.',
            ...
            'share_meta_description_named' => 'Veja o elenco de 53 jogadores dos Seahawks de %s e depois monte o seu próprio roster final.',
            'share_meta_description_default' => 'Veja este elenco de 53 jogadores dos Seahawks e depois monte o seu próprio roster final.',
            ...
            'personalize_body' => 'Dê um nome ao seu elenco final e escolha uma paleta de cores para a página e a prévia do link.',
