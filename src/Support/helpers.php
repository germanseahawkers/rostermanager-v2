...
function translations(string $locale): array
{
    $messages = [
        'de' => [
            ...
            'intro_body' => 'Stelle deinen eigenen 53er-Kader zusammen, überprüfe ihn vor dem Abschluss und teile deine Prognose mit anderen 12s.',
            'intro_build_title' => 'Baue deinen Seahawks-Kader',
            'intro_build_body' => 'Nutze dieses Tool, um deinen eigenen 53er-Kader zu erstellen. Wähle eine Positionsgruppe aus und klicke auf die Spieler aus dem aktuellen 90-Mann-Kader der Seattle Seahawks, die in dein Team gehören sollen.',
            'intro_share_title' => 'Veröffentliche und teile deinen Seahawks-Kader',
            'intro_share_body' => 'Wenn du fertig bist, überprüfst du deinen Kader vor dem Abschluss, speicherst dein Team als hochauflösende Share-Grafik und diskutierst deine Prognose mit anderen 12s.',
            'intro_adjust_title' => 'Starte neu und justiere deinen Seahawks-Kader',
            'intro_adjust_body' => 'Ein NFL-Team entsteht nicht an einem Tag. Die Personalsituation verändert sich und damit auch der Kader. Komm zurück und wiederhole den Prozess, bis du mit deinen Cuts zufrieden bist.',
        ...
        'en' => [
            ...
            'intro_title' => 'Seahawks Cutdown',
            'intro_body' => 'Build your own 53-man squad, review it before you finalize and share your roster call with fellow 12s.',
            'intro_build_title' => 'Build your Seahawks roster',
            'intro_build_body' => 'Use this tool to generate your own 53-man squad. Select a position group and click on the players from the Seattle Seahawks\' current 90-man roster that you want to be part of your team.',
            'intro_share_title' => 'Publish and share your Seahawks roster',
            'intro_share_body' => 'Once you are finished, review your roster before finalizing it, save your team as a high-quality share graphic and discuss your roster prognosis with fellow 12s.',
            'intro_adjust_title' => 'Start over and adjust your Seahawks roster',
            'intro_adjust_body' => 'An NFL team is not built in one day. Personnel situations change and so does the roster. Come back and repeat the process until you are happy with your roster cuts and your Seahawks team.',
        ...
        'es' => [
            ...
            'intro_title' => 'Seahawks Cutdown',
            'intro_body' => 'Construye tu plantel final de 53, revísalo antes de cerrarlo y comparte tu pronóstico con otros 12s.',
            'intro_build_title' => 'Construye tu roster de los Seahawks',
            'intro_build_body' => 'Usa esta herramienta para crear tu propio roster de 53 jugadores. Elige un grupo de posición y haz clic en los jugadores del actual plantel de 90 de los Seattle Seahawks que quieres en tu equipo.',
            'intro_share_title' => 'Publica y comparte tu roster de los Seahawks',
            'intro_share_body' => 'Cuando termines, revisa tu roster antes de cerrarlo, guarda tu equipo como imagen de alta calidad para compartir y comenta tu pronóstico con otros 12s.',
            'intro_adjust_title' => 'Empieza de nuevo y ajusta tu roster de los Seahawks',
            'intro_adjust_body' => 'Un equipo de la NFL no se construye en un solo día. La situación del personal cambia y el roster también. Vuelve cuando quieras y repite el proceso hasta estar satisfecho con tus cortes.',
        ...
        'fr' => [
            ...
            'intro_title' => 'Seahawks Cutdown',
            'intro_body' => 'Construis ton groupe final de 53 joueurs, vérifie-le avant validation et partage ton pronostic avec les autres 12s.',
            'intro_build_title' => 'Construis ton roster des Seahawks',
            'intro_build_body' => 'Utilise cet outil pour créer ton propre groupe de 53 joueurs. Choisis un groupe de position et clique sur les joueurs du roster actuel de 90 joueurs des Seattle Seahawks que tu veux garder.',
            'intro_share_title' => 'Publie et partage ton roster des Seahawks',
            'intro_share_body' => 'Une fois terminé, vérifie ton effectif avant validation, enregistre ton équipe sous forme de visuel de partage haute qualité et discute de ton pronostic avec les autres 12s.',
            'intro_adjust_title' => 'Repars de zéro et ajuste ton roster des Seahawks',
            'intro_adjust_body' => 'Une équipe NFL ne se construit pas en un jour. La situation de l’effectif évolue, et le roster aussi. Reviens quand tu veux et recommence jusqu’à ce que tes cuts te conviennent.',
        ...
        'pt' => [
            ...
            'intro_title' => 'Seahawks Cutdown',
            'intro_body' => 'Monte o seu grupo final de 53 jogadores, revise antes de fechar e compartilhe a sua previsão com outros 12s.',
            'intro_build_title' => 'Monte o seu roster dos Seahawks',
            'intro_build_body' => 'Use esta ferramenta para criar o seu próprio elenco de 53 jogadores. Escolha um grupo de posição e clique nos jogadores do atual elenco de 90 jogadores dos Seattle Seahawks que você quer manter.',
            'intro_share_title' => 'Publique e compartilhe o seu roster dos Seahawks',
            'intro_share_body' => 'Quando terminar, revise o seu elenco antes de concluir, salve a sua equipe como uma arte de compartilhamento em alta qualidade e discuta a sua previsão com outros 12s.',
            'intro_adjust_title' => 'Recomece e ajuste o seu roster dos Seahawks',
            'intro_adjust_body' => 'Um time da NFL não é construído em um único dia. A situação do elenco muda e o roster muda junto. Volte quando quiser e repita o processo até ficar satisfeito com os seus cortes.',
